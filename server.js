// This file starts the backend server and connects the app to MongoDB.
...
// Middleware
// app.use(cors({ origin: 'karibu-groceries.netlify.app' }));\
app.use(cors()); // Allow requests from localhost:3000 for development
...
app.listen(PORT, () => {
  console.log(`Server is running on port ${PORT} Db: ${MONGODB_URI}`);
});
